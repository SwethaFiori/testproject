		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comnstestprojecttestproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnstestprojecttestproject-display": {
								"semanticObject": "comnstestprojecttestproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ns.testproject.testproject",
									"url": sap.ui.require.toUrl("com/ns/testproject/testproject")
								}
							}
						}
					}
